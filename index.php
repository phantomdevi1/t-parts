        ...
        <div class="news_index">
            ...
            <div class="news_block">
                <div class="one_news_block">
                    <p class="one_news_block-title">Заголовок</p>
                    <p class="one_news_block-date">24.03.2025</p>
                    <p class="one_news_block-text">Эх, слетать бы на Гаити, помороситьНо вот в кармане пятикрылый остался гостить (Бля)Да и милая моя требует вниманияЯ её понимаю, вот и сижу мечтаю (Точно)На Гаити ни ГАИ ни ДПС не встретишьПозагораешь, поныряешь — в общем отдохнёшь (Да)И если будет возможность в помощь попутный ветер (Заебись)Взлёт, мягкая посадка и всё, ты орёшь (По-любому)Я помню чудное мгновение в Паттайя-ситиТам каждый вечер можно было меня заносить (Ха-ха-ха)Лабиринтами, клубы, в кальянной, клубыДыма, Дима не равнодушен был, любил пошалитьБлять, как же хочется под солнце южноеПодальше от морозов, снега, ветров и стужПо горячему песку за руку, самое нужноеЧтобы она — моя жена, а я её муж</p>
                </div>
                <div class="one_news_block">
                    <p class="one_news_block-title">Заголовок</p>
                    <p class="one_news_block-date">24.03.2025</p>
